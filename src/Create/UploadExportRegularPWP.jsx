...
const OPOR_COL = {
    ...
    "SlpCode": 20,
    "TaxDate": 28,
    "U_AP_APVNO": 141,   // col141 sa Row 1
    "U_G_PREPBY": 148,   // col148 sa Row 1
    "U_G_REMARKS": 152,  // col152 sa Row 1
};
const POR1_COL = {
    "NumAtCard": 2,
    "Dscription": 5,
...
function buildOporHeaderRow3() {
    ...
    row[151] = "Default";   // col151 = Default ✅ — ito lang, wag dagdag
    row[153] = "Default";   // col153 = Default ✅
    row[154] = "Default";
...
const UploadExportRegularPWP = () => {
    ...
    const fetchAllRecordsForExport = async () => {
        ...
        try {
            ...
            // ✅ I-filter out yung walang valid SAP Vendor Code
            filteredData = filteredData.filter(r => {
                const sapCode = distributorMap[r.distributor]?.sap_vendor_code;
                return sapCode && sapCode.toString().trim() !== "";
            });
