                    ...
                    <tbody>
                      {submittedBudgets
                        ...
                        .filter((budget) => {
                          ...
                          const cover = budget.cover_code?.toLowerCase() || "";
                          const distributorName = dist?.name?.toLowerCase() || "";
                          const distributorCode =
                            budget.distributor_code?.toLowerCase() || "";
                          return (
                            cover.includes(search) ||
                            distributorName.includes(search) ||
                            distributorCode.includes(search)
                          );
                        })
                        .slice(
