        ...
        const roleCategories = [
            ...
            "ApprovalList", "ManageMarketing", "Calendar", "LoginPage","AnnouncementForm","RentalsForm"
            ,"AddendumCancellation","ClaimsStatusUpload"
        ];
        ...
        export default function RolePermissionForm({ onSubmit }) {
            ...
            // 1. Fetch userRoles from References where reference_type = 'UserRole'
            useEffect(() => {
                let isMounted = true;
            ...
            // 2. Fetch permissions after userRoles are loaded
            useEffect(() => {
                const fetchPermissions = async () => {
                    ...
                    // Extract unique role names from userRoles.name
                    const uniqueRoleNames = [...new Set(userRoles.map(r => r.name))];
